...
class ContentGenerator {
    ...
    processGeneratedContent(rawContent) {
        ...
        // 由于提示词已明确要求直接输出内容，这里只做基础清理
        content = this.basicContentCleanup(content);
