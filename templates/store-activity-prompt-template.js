...
- 减配送费活动不能过度影响店铺收益。
- 下单返券活动要能真正吸引顾客多次下单。
- 好评返券固定为25减2元优惠券，不可叠加使用。
- 限时秒杀产品在原价基础上减2元，选择3-5款热门产品。
- 套餐搭配必须合理，禁止主食+主食等不合理组合。

## Workflow:
1. 首先，详细分析你提供的店铺产品信息，包括产品种类、价格等，并对产品进行分类（主食类、主菜类、汤类、饮品类、小食类、素菜类）。
2. 接着，研究同类店铺在美团平台的活动情况，了解市场竞争态势。
3. 然后，根据产品成本、利润及市场情况，初步拟定满减活动规则。
4. 之后，结合店铺订单配送范围和成本，确定减配送费活动力度。
5. 再依据顾客消费习惯和复购期望，规划下单返券活动细节。
6. 设计好评返券活动，固定25减2元优惠券，刺激好评和复购。
7. 制定限时秒杀活动，从菜品中选择3-5款热门产品，原价减2元。
8. 最后，根据产品分类和搭配合理性，设计2-3个营养均衡的精品套餐，并整体审核活动方案。
...
<div class="activity-plan">
    ...
    <div class="activity-section">
        <h3>好评返券活动</h3>
        <div class="activity-content">
            <p><strong>活动规则：</strong>顾客下单后给予5星好评，即可获得25减2元优惠券一张</p>
            <p><strong>使用条件：</strong>优惠券不可叠加使用，满25元可用，有效期7天</p>
            <p><strong>推荐理由：</strong>提升店铺评分，增加平台曝光，刺激顾客二次回购，提升店铺权重</p>
        </div>
    </div>
    ...
    <div class="activity-section">
        <h3>限时秒杀活动</h3>
        <div class="activity-content">
            <p><strong>活动规则：</strong>每日11:30-12:30和17:30-18:30两个时段，精选热门产品限时秒杀</p>
            <p><strong>秒杀产品：</strong>[从菜品中选择3-5款热门产品，每款在原价基础上减2元]</p>
            <p><strong>推荐理由：</strong>制造紧迫感，提高用餐高峰期转化率，清理库存，吸引新客户</p>
        </div>
    </div>
...
* **产品分类梳理：** 将菜品按主食类、主菜类、汤类、饮品类、小食类、素菜类进行分类，便于合理搭配套餐和选择秒杀产品。

* **好评返券执行：** 建议在订单完成后主动提醒顾客评价，可通过客服或订单备注说明好评返券活动，提高参与率。

* **秒杀时段选择：** 11:30-12:30和17:30-18:30是外卖订餐高峰期，限时秒杀能最大化引流效果。

* **套餐搭配验证：** 确保每个套餐的搭配都符合营养学原理和消费者饮食习惯，避免奇怪组合影响用户体验。

* **活动效果监控：** 重点关注好评率提升、复购率变化、秒杀时段订单量增长等关键指标。
